<img src="https://capsule-render.vercel.app/api?type=venom&color=0:0f0c29,50:302b63,100:24243e&height=200&section=header&text=Bharath%20Kesav%20R&fontColor=ffffff"/>
...
[![LinkedIn](https://img.shields.io/badge/LinkedIn-Connect-0077B5?style=for-the-badge&logo=linkedin&logoColor=white)](https://www.linkedin.com/in/bharath-kesav-r-5a2067319/)
...
- 🚀 **5+ Live Deployed Apps** on HuggingFace Spaces
...
**`01` · Analytics · Manufacturing** &nbsp; 🚀 [**Live Demo**](https://huggingface.co/spaces/bk1210/Tyre-Manufacturing-Quality-Analytics-Dashboard)

### [🏭 Tyre Manufacturing Quality Analytics Dashboard](https://github.com/bk1210/tyre-manufacturing-quality-analytics)
> End-to-end manufacturing audit analytics dashboard on 3,240 production batches. Computed 10 KPIs including OEE (85.37%), cost per unit, and defect rate. X̄-R control charts with ±3σ limits identifying out-of-control months for audit escalation. Batch Risk Scorer with SHAP feature-level explainability.

`ROC-AUC 0.7417` · `OEE 85.37%` · `10 KPIs` · `Low/Medium/High Risk Classification`
...
**`02` · RAG · LLM** &nbsp; 🚀 [**Live Demo**](https://huggingface.co/spaces/bk1210/Explainable-Match-Summaries)
...
**`03` · NLP · Transformers** &nbsp; 🚀 [**Live Demo**](https://huggingface.co/spaces/bk1210/Sarcasm-Detector)
...
**`04` · ML · Sports Analytics** &nbsp; 🚀 [**Live Demo**](https://huggingface.co/spaces/bk1210/Football-Match-Outcome-Prediction)
...
**`09` · Agentic AI** &nbsp; 🚀 [**Live Demo**](https://huggingface.co/spaces/bk1210/Smart-Resource-Finder)
...
![T5](https://img.shields.io/badge/T5-FFD21E?style=flat-square&logo=huggingface&logoColor=black)
...
![RAG](https://img.shields.io/badge/RAG·FAISS·LLaMA-6366F1?style=for-the-badge)
![SHAP](https://img.shields.io/badge/SHAP·LIME·XAI-7C3AED?style=for-the-badge)
![GAT](https://img.shields.io/badge/GAT·GNN·PyG-F59E0B?style=for-the-badge)
![Power BI](https://img.shields.io/badge/Power_BI·Tableau-F2C811?style=for-the-badge&logo=powerbi&logoColor=black)
![Streamlit](https://img.shields.io/badge/Streamlit·Django-FF4B4B?style=for-the-badge&logo=streamlit&logoColor=white)
![PostgreSQL](https://img.shields.io/badge/PostgreSQL·SQLite-316192?style=for-the-badge&logo=postgresql&logoColor=white)
![Kaggle](https://img.shields.io/badge/Kaggle·Colab_GPU-20BEFF?style=for-the-badge&logo=kaggle&logoColor=white)
![LaTeX](https://img.shields.io/badge/LaTeX·Git·Overleaf-008080?style=for-the-badge&logo=latex&logoColor=white)
...
<div align="center">
  ...
  <br/><br/>
  <i>"I don't have to show anything to anyone. There is nothing to prove."</i>
  <br/><br/>
